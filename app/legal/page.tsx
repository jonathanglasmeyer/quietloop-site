        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="text-gray-300 leading-relaxed space-y-6">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold mb-4 text-white border-l-4 border-white pl-4">Information According to § 5 TMG</h2>
              <p>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold mb-4 text-white border-l-4 border-white pl-4">Contact</h2>
              <p>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold mb-4 text-white border-l-4 border-white pl-4">Responsible for Content (§ 55 Abs. 2 RStV)</h2>
              <p>
                Jonathan Glasmeyer<br />
                Redder 4<br />
                25421 Pinneberg<br />
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold mb-4 text-white border-l-4 border-white pl-4">Dispute Resolution</h2>
              <p>
                The European Commission provides a platform for online dispute resolution (OS): 
                <a href="https://ec.europa.eu/consumers/odr/" className="text-white underline-offset-4 hover:underline">https://ec.europa.eu/consumers/odr/</a>
              </p>
              <p className="mt-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold mb-4 text-white border-l-4 border-white pl-4">Liability for Content</h2>
              <p className="mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold mb-4 text-white border-l-4 border-white pl-4">Liability for Links</h2>
              <p>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold mb-4 text-white border-l-4 border-white pl-4">Copyright</h2>
              <p>
